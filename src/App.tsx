...
function App() {
  ...
  useEffect(() => {
    waitForOpenCV(10000).then(ready => {
      ...
      if (ready) {
        console.log('✅ par Normand Rocheleau ing. - chargé et prêt pour la détection avancée')
      } else {
        console.warn('⚠️ par Normand Rocheleau ing. non disponible - utilisation de la détection basique')
      }
    })
  }, [])
            ...
            <div className="flex items-center gap-2.5">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">
                  {opencvReady ? '✓ par Normand Rocheleau ing. - Détection avancée' : 'Reconnaissance de composants par IA'}
                </p>
              </div>
            </div>
